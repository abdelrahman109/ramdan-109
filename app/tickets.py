...
def create_ticket_image(booking, qr_image_path, out_path):
    ...
    y = 360
    draw.text((120, y), EVENT_NAME, fill="#7a5a12", font=title_font)
    y += 120
    draw.text((120, y), f"الاسم: {booking['name']}", fill="black", font=body_font)
    y += 70
    ...
    draw.text((150, 1380), "التذكرة صالحة لدخول مرة واحدة فقط", fill="#8a0000", font=body_font)
    draw.text((150, 1450), "يرجى الاحتفاظ بهذه التذكرة وإبرازها عند الدخول", fill="black", font=small_font)
